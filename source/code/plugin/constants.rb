class Constants
    ...
    # Setting this to a very low value so that metrics will flow
    DEFAULT_MDM_CPU_UTILIZATION_THRESHOLD = 0.0
    DEFAULT_MDM_MEMORY_RSS_THRESHOLD = 0.0
    DEFAULT_MDM_MEMORY_WORKING_SET_THRESHOLD = 0.0
